...
// Organized into sections: CORE (default layout), OPTIONAL (off by default), EXTRAS.

// === CORE: default layout plugins ===
...
// === EXTRAS: utility and separator plugins ===
...
// === EXTRAS: context & token management ===
...
const allPlugins = [
  // Core
  modelName, contextBar, contextPercent, sessionCost,
  gitBranch, gitStatus, directory, linesChanged,
  smartNudge, activity,
  // Optional
  costRate, vimMode, sessionTimer, costBudget,
  contextTokens, apiTimer, version, outputStyle,
  // Utility
  separatorPipe, separatorArrow, separatorSpace, flexSpace, customText,
  // Fun & personality
  tamagotchi, vibeCheck, achievement, tokenSparkline,
  narrator, streak, soundtrack, fortuneCookie, horoscope,
  ...
  tokenRate, costPerLine, tokensPerDollar,
